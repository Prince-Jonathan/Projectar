...
const TaskDetailsStatus = (props) => {
  ...
  return (
    ...
    >
      <Button
        onClick={() =>
          history.push(`${url}/${props.task? props.task.id:"0"}/details`, {...location.state, task:props.task.details})
        }
      ...
      >
        Recent Status:{" "}
        <div style={{ color: props.task?color[props.task.details[0].entry_type]:"white", fontWeight: 500 }}>
