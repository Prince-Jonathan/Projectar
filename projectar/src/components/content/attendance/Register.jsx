                        ...
                        const [isPresent] = useState(() => {
                            try {
                                return isPresents.filter(
                                    (isPresent) =>
                                        isPresent.id === row.original.id
                                )[0].isPresent;
                            } catch (err) {}
                        });

                        const isPersonnelPresent = isPresent
                            ? isPresent
                            : false;
                        return (
                            <input
                        ...
                        const [lunch] = useState(() => {
                            try {
                                return lunchs.filter(
                                    (lunch) => lunch.id === row.original.id
                                )[0].lunch;
                            } catch (err) {}
                        });
